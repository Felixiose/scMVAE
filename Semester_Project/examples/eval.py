...
def main() -> None:
    ...
    dataset = create_dataset(args.dataset, args.batch_size, args.data) #TODO -> Andrei check if it makes sense with you dataclass
    print("#####")
    ...
    if args.dataset in ["mnist", "omniglot", "bdp"]:      #TODO -> ANDREI TELL THE NAME OF THE DATASET
